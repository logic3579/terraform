...
| **storage** | `google_storage_bucket`, `google_storage_bucket_iam_member` | Uniform bucket-level access, public_access_prevention enforced by default, dynamic `lifecycle_rule` blocks, triple-nested flatten for bucket IAM |
